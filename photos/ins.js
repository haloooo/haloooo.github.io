  ...
  function(module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://picture-1253945601.cos.ap-chengdu.myqcloud.com/picture/' + data.link[i];
          var src = 'https://picture-1253945601.cos.ap-chengdu.myqcloud.com/picture/' + data.link[i];
    ...
    function loadData(success) {
      if (!searchData) {
        ...
        //xhr.open('GET', 'https://picture-1253945601.cos.ap-chengdu.myqcloud.com/', true);
        xhr.onload = function() {
